...
type Props = ImageSplitProps & WithStyles<typeof styles>;

const Component: React.SFC<Props> = ({
  classes, before, after, id, reverse, heading, subheading, body, image}) => (
  <HorizontalSplit
    id={id}
    reverse={reverse}
...
export const ImageSplit = withStyles(styles)(Component);
